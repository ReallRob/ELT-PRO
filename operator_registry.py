...
from operators.panels.aggregate_panels import DescribePanel, MeltPanel, PivotPanel
...
from operators.panels.template_panels import ImportTemplatePanel, InsertBlockPanel, SaveTemplatePanel
...
from operators.panels.flow_panels import CleanFlowPanel, FilterFlowPanel, GroupFlowPanel, SortFlowPanel
...
NODE_REGISTRY = {
    ...
    "filter_data":     {"title": "数据筛选",   "color": "#E91E63", "panel_class": FilterFlowPanel,      "category": "数据变换"},
    "sort_data":       {"title": "多级排序",   "color": "#FF9800", "panel_class": SortFlowPanel,        "category": "数据变换"},
    "clean_data":      {"title": "数据清洗",   "color": "#FF5722", "panel_class": CleanFlowPanel,       "category": "数据变换"},
    ...
    "group_calc":      {"title": "分组汇总",   "color": "#673AB7", "panel_class": GroupFlowPanel,       "category": "汇总统计"},
    ...
    "import_template": {"title": "加载模板",   "color": "#795548", "panel_class": ImportTemplatePanel,  "category": "实验功能"},
    "insert_block":    {"title": "写入模板",   "color": "#FF6F00", "panel_class": InsertBlockPanel,     "category": "实验功能"},
    "save_template":   {"title": "保存模板",   "color": "#607D8B", "panel_class": SaveTemplatePanel,    "category": "实验功能"},
